...
class Admin extends CI_Controller
{
	...
	function index(){
		...
		$where = array('status_peminjaman' => '0', 'status_pengembalian' => '0');

		$data['transaksi'] = $this->db->query("SELECT * from transaksi where status_peminjaman = '0' order by id_anggota desc limit 10")->result();
	...
	public function tambah_kategori_act()
	{
	...
	public function edit_kategori($id)
	{
		...
		$this->load->view('admin/dashboard/header');
		$this->load->view('admin/kategori/edit/index',$data);
		$this->load->view('admin/dashboard/footer');
	}
	...
	public function update_kategori()
	{
		...
		if($data > 0)
		{
			$this->M_perpus->update_data('kategori', $data,$where);
			redirect('admin/kategori');
		}
	}
	...
	function tambah_buku(){
		$data['kategori'] = $this->M_perpus->get_data('kategori')->result();
		$this->load->view('admin/headertambah_buku');
	...
	function edit_buku($id){
		...
		$this->load->view('admin/dashboard/header');
		$this->load->view('admin/buku/edit/index',$data);
		$this->load->view('admin/dashboard/footer');
	}
	...
	public function tambah_anggota_act()
	{
	...
	public function edit_anggota($id)
	{
		...
		$data['anggota'] = $this->db->query("SELECT * from anggota A where A.id_anggota='$id'")->result();

		$this->load->view('admin/dashboard/header');
		$this->load->view('admin/anggota/edit/index',$data);
		$this->load->view('admin/dashboard/footer');
	}
	...
	public function tambah_peminjaman_act()
	{
	...
	public function transaksi_selesai($id)
	{
    	...
    	$data['buku'] = $this->M_perpus->get_data('buku')->result();
    	$data['anggota'] = $this->M_perpus->get_data('anggota')->result();
    	$data['peminjaman'] = $this->db->query("SELECT * from transaksi where id_pinjam='$id'")->result();

		$this->load->view('admin/dashboard/header');
		$this->load->view('admin/peminjaman/edit/index',$data);
		$this->load->view('admin/dashboard/footer');
	}
