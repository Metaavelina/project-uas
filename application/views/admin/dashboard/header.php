...
<head>
    ...
    <!-- Dropzone Css-->
    <link href="<?= base_url()?>assets/member/plugins/dropzone/dropzone.css" rel="stylesheet" />

    <!-- Animation Css -->
    <link href="<?= base_url()?>assets/member/plugins/animate-css/animate.css" rel="stylesheet" />

    <!-- Morris Chart Css-->
    <link href="<?= base_url()?>assets/member/plugins/morrisjs/morris.css" rel="stylesheet" />

    <!-- Bootstrap Select Css-->
    <link href="<?= base_url()?>assets/member/plugins/bootstrap-select/css/bootstrap-select.css" rel="stylesheet" />

    <!-- Custom Css -->
    <link href="<?= base_url()?>assets/member/css/style.css" rel="stylesheet">

    <!-- AdminBSB Themes. You can choose a theme from css/themes instead of get all themes -->
    <link href="<?= base_url()?>assets/member/css/themes/all-themes.css" rel="stylesheet" />
</head>